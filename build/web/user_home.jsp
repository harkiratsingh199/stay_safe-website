    ...
    <body>
        ...
        <div id="top">
            <div class="container">
                <div class="row">
                    <div class="pull-left">
                        <p >Contact us on staysafe.web199@gmail.com.</p>

                    </div>


                    <div class="pull-right">
                        <a href="user_login1.jsp"><span class="glyphicon glyphicon-log-in"></span>Sign in</a>
                        <a href="user_signup.jsp"><span class="glyphicon glyphicon-log-out"></span>Sign up</a>
                    </div>
